...
@dataclass
class RandomCameraOriDataModuleConfig:
...
class RandomCameraOriIterableDataset(IterableDataset, Updateable):
    def __init__(self, cfg: Any) -> None:
        super().__init__()
        self.cfg: RandomCameraOriDataModuleConfig = cfg
...
class RandomCameraOriDataset(Dataset):
...
@register("random-camera-original-datamodule")
class RandomCameraOriDataModule(pl.LightningDataModule):
    cfg: RandomCameraOriDataModuleConfig

    def __init__(self, cfg: Optional[Union[dict, DictConfig]] = None) -> None:
        super().__init__()
        self.cfg = parse_structured(RandomCameraOriDataModuleConfig, cfg)

    def setup(self, stage=None) -> None:
        if stage in [None, "fit"]:
            self.train_dataset = RandomCameraOriIterableDataset(self.cfg)
        if stage in [None, "fit", "validate"]:
            self.val_dataset = RandomCameraOriDataset(self.cfg, "val")
        if stage in [None, "test", "predict"]:
            self.test_dataset = RandomCameraOriDataset(self.cfg, "test")
